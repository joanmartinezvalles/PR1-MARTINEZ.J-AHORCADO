...
namespace JuegoAhorcado
{
    class AhorcadoV1
    {
        public static void Main()
        {
            ...
            string palabraAdivinar = logica.ListaPalabras();

            string palabraMostrar = logica.PalabraOculta(palabraAdivinar);

            palabraMostrar = logica.JuegoAhorcado(palabraAdivinar, palabraMostrar);

            Console.ReadKey();
        }

        //private static string JuegoAhorcado(string palabraAdivinar, string palabraMostrar)
        //{
        ...
        //private static string PalabraOculta(string palabraAdivinar)
        //{
